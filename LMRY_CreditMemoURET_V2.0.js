...
define(['N/currency', 'N/log', 'N/config', 'N/ui/serverWidget', 'N/record', 'N/search', 'N/runtime',
  ...
  './Latam_Library/LMRY_PE_MapAndSaveFields_LBRY_v2.0','./Latam_Library/LMRY_PY_ST_Sales_Tax_Transaction_LBRY_V2.0',
  ...
  function (currency, log, config, serverWidget, record, search, runtime, libraryMail, library_HideView, libraryValidation, libraryNumber,
    ...
    MX_ST_TaxLibrary, CO_ST_TaxLibrary,PE_libMapTransactions, PY_ST_TaxLibrary, CO_ST_WhtLibrary_Lines) {
            ...
            if (["copy", "xcopy"].indexOf(scriptContext.type) != -1) {
              switch (LMRY_Result[0]) {
                ...
                case "CO":
                  ...
                  break;
                case "PY":
                  PY_ST_TaxLibrary.deleteTaxDetailLines(recordObj);
                  break;
              }
            }
            ...
            switch (LMRY_Result[0]) {
              ...
              case "CO":
                ...
                if (libraryMail.getAuthorization(340, licenses) == true) {
                    CO_ST_WhtLibrary_Lines.deleteRelatedRecords(LMRY_Intern, "creditmemo");
                }
                break;
              case "PY":
        ...
        if (["create", "edit", "copy"].indexOf(scriptContext.type) != -1) {
          ...
          if (ST_FEATURE == true || ST_FEATURE == "T") {
            ...
            switch (LMRY_Result[0]) {
              ...
              case "PY":
                if (libraryMail.getAuthorization(715, licenses) == true) {
