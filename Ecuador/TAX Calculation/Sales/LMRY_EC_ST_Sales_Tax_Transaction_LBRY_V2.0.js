...
||                                                              ||
||  File Name: LMRY_EC_ST_Sales_Tax_Transaction_LBRY_V2.0.js    ||
||                                                              ||
||  Version Date          Author        Remarks                 ||
||  2.0     DIC 15 2021   LatamReady    Use Script 2.0          ||
 \= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = */
...
define([
  ...
  var LMRY_SCRIPT = "LMRY - EC ST Sales Tax Transaction V2.0";
  var LMRY_SCRIPT_NAME = "LMRY_EC_ST_Sales_Tax_Transaction_LBRY_V2.0.js";
  ...
  function disableInvoicingIdentifier(scriptContext) {
    try {
      ...
      // 91 invoice standard form
      // 94 credit memo form
      if (typeForm === 91 || typeForm === 94) {
    ...
    if (itemLineCount != "" && itemLineCount != 0) {
      ...
      for (var i = 0; i < itemLineCount; i++) {
        ...
        if (itemInvoiceIdentifier === null || itemInvoiceIdentifier === "") {
          ...
          log.debug("[Si no se selecciona una opcion de impuestos]", i);
          continue;
        }
