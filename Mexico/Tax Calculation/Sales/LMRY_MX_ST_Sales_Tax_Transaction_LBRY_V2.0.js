...
||                                                              ||
||  File Name: LMRY_MX_ST_Sales_Tax_Transaction_LBRY_V2.0.js    ||
||                                                              ||
...
define(['N/log', 'N/record', 'N/search', 'N/runtime', 'N/ui/serverWidget',
    ...
    function(log, record, search, runtime, serverWidget, Library_Mail, Library_Log) {
        ...
        var LMRY_SCRIPT = 'LMRY - MX ST Sales Tax Transaction V2.0';
        var LMRY_SCRIPT_NAME = 'LMRY_MX_ST_Sales_Tax_Transaction_LBRY_V2.0.js';
        ...
        function getNationalTaxes(subsidiary, transactionDate, filtroTransactionType, documentType) {
            ...
            try {
                ...
                var NT_Filters = [
                    ...
                    search.createFilter({ name: 'custrecord_lmry_ntax_gen_transaction', operator: 'ANYOF', values: ["6"] }) // 1:Journal, 2:SuiteGl, 3:LatamTax(Purchase), 4:Add Line, 5: WhtbyTrans, LatamTax (Sales)
                ];
                ...
                NT_Filters.push({ name: "custrecord_lmry_ntax_fiscal_doctype", operator: "ANYOF", values: documents });

                if (FEATURE_SUBSIDIARY === true ||  FEATURE_SUBSIDIARY === "T") {
                    NT_Filters.push({ name: "custrecord_lmry_ntax_subsidiary", operator: "ANYOF", values: subsidiary });
                }
