...
||                                                              ||
||  File Name: LMRY_BoletoBancarioBRDLBRY_V2.0.js               ||
||                                                              ||
...
define(['N/record', 'N/file', 'N/record', 'N/render', 'N/url', 'N/log', 'N/xml', 'N/https', 'N/search', 'N/runtime', 'N/format', 'N/format/i18n', 'N/config', './LMRY_libSendingEmailsLBRY_V2.0'],
  function (record, file, record, render, url, log, xml, https, search, runtime, format, format2, config, libraryMail) {
    ...
    var LMRY_script = 'LMRY_BoletoBancarioBRDLBRY_V2.0.js';
    var LANGUAGUE = '';
    var MSJ_ANULADO = '';
    ...
    function formarInstallments(installment) {
      try {
        ...
        if (FOLDER_BR) {
          ...
          linkBoleto = formarPDF(AMOUNT_INV, AMOUNT_LETTERS_INV, '', duedate);
          ...
          if (installments && libraryMail.getAuthorization(536, licenses)) {
            ...
            if (Object.keys(jsonInstallments).length) {
              for (var idInstallment in jsonInstallments) {
                ...
                var dueDate = jsonInstallments[idInstallment]["duedate"];
                ...
                var link = formarPDF(monto, montoText, idInstallment, dueDate);
              ...
              if (resultInstallments != null && resultInstallments != '' && installNumber != '' && installNumber != null) {
                for (var i = 0; i < resultInstallments.length; i++) {
                  ...
                  var link = formarPDF(monto, montoText, internalId, dueDate);
                  arrayBoletos.push(link);
    ...
    function formarPDF(monto, montoText, cod, dueDate) {
      try {
        var shortLink = '';

        obtenerCodigoBarras(monto, dueDate);
        obtenerLineaDigital();
        var htmlFinal = '';
        var dueDateFormat = "";
        if (dueDate) {
          dueDateFormat = formatoFecha(dueDate);
        }
        htmlFinal += reciboPagador(montoText, dueDateFormat);
        htmlFinal += fichaCompensacion(montoText, dueDateFormat);
        ...
        if (cod != '') {
          myFileObj.name = 'BR_BB_BRD_' + ID_INV + '_' + cod + '.pdf';
        } else {
          myFileObj.name = 'BR_BB_BRD_' + ID_INV + '.pdf';
        }
    ...
    function obtenerDatosCustomer() {
      try {
        ...
        var customer_columns = ['isperson', 'firstname', 'lastname', 'companyname', 'custentity_taxpayer_number_sv'];
    ...
    function calcularDVNossoNumero(nosso_number) {
      try {
        ...
        var cadena = CARTERA + nosso_number;
    ...
    function obtenerCodigoBarras(monto, dueDate) {
      try {
        ...
        agenciaCodBarras = AGENCY.replace(/\-|\.| |\,/g, '');

        if (agenciaCodBarras.length > 4) {
          agenciaCodBarras = agenciaCodBarras.substring(0, 4);
        } else {
          while (agenciaCodBarras.length < 4) {
            agenciaCodBarras = "0" + agenciaCodBarras;
          }
        }

        cartera = CARTERA.substring(0, 2);
        nossoNumero = NOSSO_NUMBER.substring(0, 11);
        ...
        cadena = codBanco + codMoneda + factorVencimiento + valorBoleto + agenciaCodBarras + cartera + nossoNumero + codBenefCodBarras + '0';
        digVerificador = calcularDVCodBarras(cadena);
        BARCODE = codBanco + codMoneda + digVerificador + factorVencimiento + valorBoleto + agenciaCodBarras + cartera + nossoNumero + codBenefCodBarras + '0';
    ...
    function obtenerLineaDigital() {
      try {
        ...
        var campo4 = BARCODE.substring(19, 24); // Agencia (4 dígitos) + primer digito de cartera
        var campo5 = BARCODE.substring(24, 34); // 2do digito de cartera + Nosso Numero (primeros 9 dígitos)
        var campo6 = BARCODE.substring(34, 44); // Nosso Número (2 dígitos restantes)+ Número Beneficiario + 0
        ...
        //Campo1
        var dig1_campo4 = campo4.substring(0, 1); //Primer dígito de Agencia
        var dig2_campo4 = campo4.substring(1, 5); //Agencia(3 dígitos restantes) + primer digito de cartera
        var nuevo_campo4 = dig1_campo4 + "." + dig2_campo4;

        //Campo2
        var dig1_campo5 = campo5.substring(0, 5); //2do dígito de cartera + Nosso Número (Primeros 4 dígitod)
        var dig2_campo5 = campo5.substring(5, 10); // Nosso Número (5 dígitos)
        ...
        //Campo4-->DV del codigo de Barras
        //Campo5--->FactorVencimiento(4 digitos) + valorTitulo(10 digitos)
        DIGITAL_LINE = campo1 + nuevo_campo4 + digVerificador1 + " " + nuevo_campo5 + digVerificador2 + " " + nuevo_campo6 + digVerificador3 + " " + campo2 + " " + campo3;
    ...
    function reciboPagador(monto, dueDate) {
      try {
        ...
        html += "<tr>";
        html += "<td style=\"font-size:6.8pt; border-left:1px; border-right:1px; padding-bottom:0px\" align=\"left\" colspan=\"6\">Local do pagamento</td>";
        html += "</tr>";

        html += "<tr style=\"border-bottom:1px \">";
        html += "<td colspan=\"6\" align=\"left\" style=\"border-right:1px; border-left:1px; font-size:8pt\">" + PLACE_PAYMENT + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px\" colspan=\"3\" align=\"left\">Nome do beneficiário/CPF/CNPJ/Endereço</td>";
        html += "<td style=\"font-size: 6.8pt; border-left:1px\" colspan=\"2\" >Agência / Código do Cedente</td>";
        html += "<td style=\"font-size: 6.8pt; border-left:1px; border-right:1px\" colspan=\"1\" >Data de Vencimento</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size: 8pt;border-left:1px;padding-bottom:0px\" colspan=\"3\" align=\"left\">" + NAME_SUBSIDIARY + CNPJ_SUBSIDIARY + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"2\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; border-right:1px\" align=\"left\" colspan=\"1\"></td>";
        html += "</tr>";

        html += "<tr style=\"border-bottom:1px\">";
        html += "<td style=\"font-size: 8pt;border-left:1px;padding-bottom:0px; border-top:-3px\" colspan=\"3\" align=\"left\">" + ADDRESS_SUBSIDIARY + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; border-top:-3px\" align=\"left\" colspan=\"2\">" + AGENCY_BENEFICIARY_CODE + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; border-right:1px; border-top:-3px\" align=\"left\" colspan=\"1\">" + dueDate + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px\" colspan=\"1\" >Data do Documento</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px \" colspan=\"1\" >Data do Processamento</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px \" colspan=\"1\" >Carteira</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px\" colspan=\"1\" >N° documento</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px\" colspan=\"1\" >Nosso Número</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px;border-right:1px\" colspan=\"1\" >(=) Valor do documento</td>";
        html += "</tr>";
        html += "<tr style=\"border-bottom:1px \">";
        ...
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"1\">" + NOSSO_NUMBER + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px;border-right:1px\" align=\"left\" colspan=\"1\">" + monto + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px\" colspan=\"2\" >(-) Desconto / Abatimento </td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px \" colspan=\"1\" >(-) Outras deduções</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px \" colspan=\"1\" >(+) Mora / Multa</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px\" colspan=\"1\" >(-) Outros Acrécimos</td>";
        html += "<td style=\"font-size: 6.8pt;border-left:1px;border-right:1px\" colspan=\"1\" >(=) Valor cobrado</td>";
        html += "</tr>";
        html += "<tr style=\"border-bottom:1px \">";
        html += "<td style=\"font-size: 8pt;border-left:1px; min-height:16px\" align=\"left\" colspan=\"2\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; min-height:16px\" align=\"left\" colspan=\"1\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; min-height:16px\" align=\"left\" colspan=\"1\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; min-height:16px\" align=\"left\" colspan=\"1\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; min-height:16px;border-right:1px\" align=\"left\" colspan=\"1\"></td>";
        html += "</tr>";


        html += "<tr>";
        html += "<td style=\"font-size:6.8pt;border-left:1px\" colspan=\"1\" align=\"left\">Nome do Pagador/CPF/CNPJ/Endereço</td>";
        html += "<td colspan=\"5\" align=\"left\" style=\"border-right:1px\"> </td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:8pt;border-left:1px;border-right:1px;\" colspan=\"6\" align=\"left\">" + NAME_CUSTOMER + CNPJ_CUSTOMER + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:8pt;border-left:1px;border-right:1px; border-top:-5px;\" colspan=\"6\" align=\"left\">" + ADDRESS_CUSTOMER1 + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:8pt;border-left:1px;border-right:1px; border-top:-8px;\" colspan=\"6\" align=\"left\">" + ADDRESS_CUSTOMER2 + "</td>";
        html += "</tr>";

        html += "<tr style=\"border-bottom:1px\">";
        html += "<td style=\"font-size:6.8pt;border-left:1px\" colspan=\"2\" align=\"left\">Nome do Sacador/Avalista/CPF/CNPJ/Endereço</td>";
        html += "<td colspan=\"4\" align=\"left\" style=\"border-right:1px\"> </td>";
        html += "</tr>";
    ...
    function fichaCompensacion(monto, dueDate) {
      try {

        var html = "";
        html += "<table style=\"font-family: Verdana, Arial, Helvetica, sans-serif; width:100%;align:center; margin-top:1px\">";
        html += "<tr>";
        html += "<td style=\"font-size: 5.8pt;padding-top:6.5px;padding-bottom:30px;padding-right:0px; padding-left:540px\" align=\"right\">Auntênticação Mecânica - Recibo</td>";
        html += "</tr>";
        html += "<tr>";
        ...
        html += "<table style=\"font-family: Verdana, Arial, Helvetica, sans-serif; width:100%; align:center;margin-top:15px; border-bottom:1.0px;padding-top:0px\" >";
        html += "<tr>";
        html += "<td valign=\"bottom\" align=\"left\" colspan=\"1\" width=\"25%\" style=\"padding-left:0px;padding-bottom: 4px;padding-right:0px \"><img  src=\"" + xml.escape(URL_LOGO) + "\" width=\"120\" height=\"20\"/></td>";
        html += "<td valign=\"bottom\"  colspan=\"1\" width=\"10%\">  <p style=\"border-left:1px; border-right:1px;  padding-bottom: -2px; padding-left:12px ;padding-right:12px; padding-top:9px\">  <b> " + BANK_CODE + "-" + DV_CODE + "</b> </p></td>";
        html += "<td valign=\"bottom\"  align=\"right\" colspan=\"5\" width=\"65%\"> <p style=\"padding-bottom: -2px;font-size: 11.5pt\"> <b>" + DIGITAL_LINE + " </b> </p></td>";
        ...
        html += "<tr>";
        html += "<td style=\"font-size: 6.8pt; border-left:1px\" colspan=\"1\">Local de Pagamento</td>";
        html += "<td colspan=\"4\" align=\"left\"> </td>";
        html += "<td style=\"font-size: 6.8pt; border-left:1px; border-right:1px; background-color:#CBCCCD\" colspan=\"2\">Data de Vencimento</td>";
        html += "</tr>";
        html += "<tr style=\"border-bottom:1px\">";
        html += "<td style=\"font-size: 8pt;border-left:1px\" colspan=\"5\" align=\"left\">" + reemplazarCaracteresEspeciales(PLACE_PAYMENT) + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; border-right:1px; background-color:#CBCCCD\" colspan=\"2\" align=\"right\">" + dueDate + "</td>";
        html += "</tr>"

        html += "<tr>";
        html += "<td style=\"font-size:6.8pt; border-left:1px\" colspan=\"5\" align=\"left\">Nome do beneficiário/CPF/CNPJ/Endereço</td>";
        html += "<td style=\"font-size:6.8pt; border-left:1px; border-right:1px\" colspan=\"2\" align=\"left\">Agência/Código do Beneficiário</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size: 8pt ;border-left:1px\" align=\"left\" colspan=\"5\">" + NAME_SUBSIDIARY + CNPJ_SUBSIDIARY + "</td>";
        html += "<td style=\"font-size: 8pt;border-left:1px; border-right:1px\" colspan=\"2\"  align=\"right\"></td>";
        html += "</tr>";

        html += "<tr style=\"border-bottom:1px\">";
        html += "<td style=\"font-size: 8pt ;border-left:1px; border-top:-5px\" align=\"left\" colspan=\"5\">" + ADDRESS_SUBSIDIARY + "</td>";
        html += "<td style=\"font-size: 8pt;border-left:1px; border-right:1px; border-top:-5px\" colspan=\"2\"  align=\"right\">" + AGENCY_BENEFICIARY_CODE + "</td>";
        html += "</tr>";
        ...
        html += "<td style=\"font-size: 6.8pt; border-left:1px; border-right:1px\" colspan=\"2\" >Nosso Número</td>";
        html += "</tr>";
        html += "<tr style=\"border-bottom:1px\">";
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"1\">" + DATE_INV + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"1\">" + NRO_DOCUMENT + "</td>";
        ...
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"1\">" + DATE_INV + "</td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; border-right:1px\" align=\"right\" colspan=\"2\">" + NOSSO_NUMBER + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size: 6.8pt; border-left:1px\" colspan=\"1\" >Uso do Banco </td>";
        html += "<td style=\"font-size: 6.8pt; border-left:1px \" colspan=\"1\" >Carteira </td>";
        ...
        html += "<td style=\"font-size: 6.8pt; border-left:1px; border-right:1px; background-color:#CBCCCD\" colspan=\"2\" >(=) Valor do documento</td>";
        html += "</tr>";
        html += "<tr style=\"border-bottom:1px \">";
        ...
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"1\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px\" align=\"left\" colspan=\"1\"></td>";
        html += "<td style=\"font-size: 8pt; border-left:1px; border-right:1px; background-color:#CBCCCD\" align=\"right\" colspan=\"2\">" + monto + "</td>";
        html += "</tr>";

        html += "<tr >";
        html += "<td style=\"font-size:6.8pt; border-left:1px\" colspan=\"5\" rowspan=\"6\"> <p style=\"font-size:6.8pt\" >Informações de responsabilidade do beneficiário</p> <p style=\"font-size:8pt; \"> " + INSTRUCTIONS + "</p>  </td>";
        html += "<td style=\"font-size:6.8pt; border-left:1px; border-right:1px\" colspan=\"2\">(-) Desconto / Abatimento</td>";
        html += "</tr>";
        html += "<tr>";
        html += "<td style=\"font-size: 8pt; border-left: 1px; border-right:1px; border-bottom:1px; min-height:16px\" align=\"left\" colspan=\"2\" >  </td>";
        html += "</tr>";
        html += "<tr >";
        html += "<td style=\"font-size:6.8pt;border-left:1px; border-right:1px\" colspan=\"2\">(+) Mora / Multa</td>";
        html += "</tr>";
        html += "<tr >";
        html += "<td style=\"font-size: 8pt; border-right:1px; border-left: 1px; border-bottom:1px; min-height:16px\" align=\"left\" colspan=\"2\" >  </td>";
        html += "</tr>";
        html += "<tr >";
        html += "<td style=\"font-size:6.8pt; border-left:1px; border-right:1px; background-color:#CBCCCD\" colspan=\"2\">(=) Valor Cobrado</td>";
        html += "</tr>";
        html += "<tr style=\"border-bottom:1px \" >";
        html += "<td style=\"font-size: 8pt; min-height:16px; border-left:1px; border-right:1px; background-color:#CBCCCD\" align=\"left\" colspan=\"2\" ></td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:6.8pt;border-left:1px\" colspan=\"1\" align=\"left\">Nome do Pagador/CPF/CNPJ/Endereço</td>";
        html += "<td colspan=\"6\" align=\"left\" style=\"border-right:1px\"> </td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:8pt;border-left:1px;border-right:1px;\" colspan=\"7\" align=\"left\">" + NAME_CUSTOMER + CNPJ_CUSTOMER + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:8pt;border-left:1px;border-right:1px; border-top:-5px;\" colspan=\"7\" align=\"left\">" + ADDRESS_CUSTOMER1 + "</td>";
        html += "</tr>";

        html += "<tr>";
        html += "<td style=\"font-size:8pt;border-left:1px;border-right:1px;border-top:-8px;\" colspan=\"7\" align=\"left\">" + ADDRESS_CUSTOMER2 + "</td>";
        html += "</tr>";
